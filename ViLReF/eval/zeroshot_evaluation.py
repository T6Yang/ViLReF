...
from ViLReF.clip.model import convert_weights, CLIP
from ViLReF.clip import tokenize
from ViLReF.training.main import convert_models_to_fp32
from ViLReF.clip.utils import image_transform
from ViLReF.eval.data import get_zeroshot_dataset, _preprocess_text
from ViLReF.eval.cvinw_zeroshot_templates import (
    openai_templates,
    flower_templates,
    food_templates,
    aircraft_templates,
