...
import ViLReF.clip as clip
from ViLReF.clip.utils import create_model, _MODEL_INFO, image_transform
from ViLReF.training.main import convert_models_to_fp32, convert_weights
from ViLReF.deploy.benchmark_utils import track_infer_time, print_timings
...
if __name__ == '__main__':
    ...
    if args.tensorrt_image_model and args.device == "cuda":
        from ViLReF.deploy.tensorrt_utils import TensorRTModel
